...
const data =[
...

  {
    ...
    title: 'Eclipse - Figma dashboard UI kit for data design web apps',
    github: 'https://github.com',
    demo: 'https://dribbble.com/shots/17096602-Eclipse-Figma-dashboard-UI-kit-for-data-design-web-apps'
  },

  {
    ...
    title: 'Eclipse - Figma dashboard UI kit for data design web apps',
    github: 'https://github.com',
    demo: 'https://dribbble.com/shots/17096515-Eclipse-Figma-dashboard-UI-kit-for-data-design-web-apps'
  }
]
      ...
      <div className="container portfolio__container">
        {
          ...
          <a href={github} className='btn' rel="noreferrer noopener" target="_blank" >Github</a>
